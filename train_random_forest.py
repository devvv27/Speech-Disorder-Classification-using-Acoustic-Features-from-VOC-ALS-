...
def main():
    ...
    print("="*60)
    print("RANDOM FOREST (100 trees) BASELINE")
    print("="*60)
    ...
    plt.close()
    print("Saved confusion matrix plot to random_forest_confusion_matrix.png")
    ...
    print("Saved results to random_forest_results.csv")
    print("="*60)
